...
public class NewBeaconMenu extends AbstractContainerMenu {
    ...
    public void updateEffects(Optional<Holder<MobEffect>> primaryEffect, Optional<Holder<MobEffect>> secondaryEffect, Optional<Holder<MobEffect>> tertiaryEffect) {
        if (this.paymentSlot.hasItem()) {
            this.beaconData.set(1, BeaconMenu.encodeEffect(primaryEffect.orElse(null)));
            this.beaconData.set(2, BeaconMenu.encodeEffect(secondaryEffect.orElse(null)));
            this.beaconData.set(3, BeaconMenu.encodeEffect(tertiaryEffect.orElse(null)));
