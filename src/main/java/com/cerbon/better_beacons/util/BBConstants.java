...
public class BBConstants {
    ...
    public static final Tooltip CANCEL_BUTTON_CLOSE_GUI_TOOLTIP = Tooltip.create(Component.translatable("block.minecraft.beacon.better_beacons.cancel_button_close_gui.tooltip"));
